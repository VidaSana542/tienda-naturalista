...
(function() {
  ...
  const newCats = [
    ...
    { key: 'belleza_y_bienestar', label: 'Belleza y bienestar', _synced: false },
    { key: 'salud_y_bienestar', label: 'Salud y bienestar', _synced: false },
    { key: 'vitaminas', label: 'Vitaminas y minerales', _synced: false },
    ...
    { key: 'vitaminas_antioxidantes', label: 'Antioxidantes', parent_key: 'vitaminas', _synced: false },
    { key: 'salud_limpieza-intestinal', label: 'Limpieza intestinal', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'suplementos_sistema-inmunologico', label: 'Sistema inmunológico', parent_key: 'suplementos', _synced: false },
    { key: 'belleza_calendula', label: 'Calendula', parent_key: 'belleza_y_bienestar', _synced: false },
    { key: 'belleza_colageno', label: 'Colageno', parent_key: 'belleza_y_bienestar', _synced: false },
    { key: 'suplementos_potencia-masculina', label: 'Potencia Masculina', parent_key: 'suplementos', _synced: false },
    { key: 'salud_rinones', label: 'Riñones y vías urinarias', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_gastritis', label: 'Gastritis y acidez', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'belleza_glucosamina', label: 'Glucosamina', parent_key: 'belleza_y_bienestar', _synced: false },
    ...
    { key: 'vitaminas_magnesio', label: 'Magnecio', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_vitamina-e', label: 'Vitamina E', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_calcio', label: 'Calcio', parent_key: 'vitaminas', _synced: false },
    ...
    { key: 'vitaminas_vitamina-c', label: 'Vitamina C', parent_key: 'vitaminas', _synced: false },
    { key: 'salud_desparasitacion', label: 'Desparasitación', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'suplementos_resveratrol', label: 'Resveratrol', parent_key: 'suplementos', _synced: false },
    { key: 'vitaminas_multivitaminicos', label: 'Multivitamínicos', parent_key: 'vitaminas', _synced: false },
    { key: 'salud_rendimiento-mental', label: 'Rendimiento mental', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'belleza_articulaciones', label: 'Articulaciones', parent_key: 'belleza_y_bienestar', _synced: false },
    { key: 'salud_salud-sueno', label: 'Salud de sueño', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_higado', label: 'Hígado y Vesícula', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_diabetes', label: 'Diabetes', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_prostata', label: 'Próstata', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_laxante', label: 'Laxante', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'suplementos_energia', label: 'Energía', parent_key: 'suplementos', _synced: false },
    { key: 'salud_omega', label: 'Omega', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'vitaminas_vitamina-b', label: 'Vitaminas B', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_vitamina-d', label: 'Vitamina D', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_vitamina-a', label: 'Vitamina A', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_zinc', label: 'Zinc', parent_key: 'vitaminas', _synced: false },
    { key: 'vitaminas_biotina', label: 'Biotina', parent_key: 'vitaminas', _synced: false },
    { key: 'salud_circulacion', label: 'Circulación', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'suplementos_sexualidad', label: 'Sexualidad', parent_key: 'suplementos', _synced: false },
    { key: 'salud_inflamacion', label: 'Inflamación', parent_key: 'salud_y_bienestar', _synced: false },
    { key: 'salud_digestion', label: 'Digestión', parent_key: 'salud_y_bienestar', _synced: false }
  ];
