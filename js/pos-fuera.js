...
function renderAccountStatus() {
    ...
    tbody.innerHTML = customers.map(c => {
        ...
        console.log('[DEBUG renderAccountStatus-fuera]', c.name, 'totalSpent:', totalSpent, 'pending:', pendingTotal, 'sales:', sales.map(s=>s.id+' tot:'+s.total+' m:'+!!s.creditInfo?.merged));
